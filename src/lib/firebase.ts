...
import { getFirestore } from "firebase/firestore"; // <— ضيفنا ده
import { getFunctions } from "firebase/functions"; // ← إضافة جديدة
...
export const functions = getFunctions(app, "us-central1"); // ← إضافة جديدة